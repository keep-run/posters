export const IMG_INFO = [
  {
    ...
    icons: [
      {
        id: "1",
        url: require("@/assets/set1/icon1.png"),
        isFooter: true,
        style: {
          width: "60%",
        },
      ...
      {
        id: "2",
        url: require("@/assets/set1/icon2.png"),
        isFooter: false,
        style: {
          position: "absolute",
          top: "55%",
      ...
      {
        id: "3",
        url: require("@/assets/set1/icon3.png"),
        isFooter: false,
        style: {
          position: "absolute",
          top: "59%",
      ...
      // {
      //   id: "4",
      //   url: require("@/assets/set1/icon4.png"),
      //   isFooter: true,
      //   style: {
      //     width: '50%',
      //   }
      ...
      {
        id: "4",
        url: require("@/assets/set2/icon5.png"),
        isFooter: true,
        style: {
          // position: "absolute",
          // top: '67%',
      ...
      {
        id: "5",
        url: require("@/assets/set1/icon5.png"),
        isFooter: true,
        style: {
          width: "50%",
        },
      ...
      {
        id: "6",
        url: require("@/assets/set1/icon6.png"),
        isFooter: true,
        style: {
          width: "35%",
        },
      ...
      {
        id: "8",
        url: require("@/assets/set2/icon1.png"),
        isFooter: true,
        style: {
          width: "66%",
        },
      ...
      {
        id: "9",
        url: require("@/assets/set2/icon2.png"),
        isFooter: true,
        style: {
          width: "44%",
        },
  ...
  },
  {
    ...
    icons: [
      ...
      {
        id: "3",
        url: require("@/assets/set2/icon3.png"),
        isFooter: true,
        style: {
          position: "absolute",
          width: "50%",
      ...
      {
        id: "4",
        url: require("@/assets/set3/icon10.png"),
        isFooter: true,
        style: {
          width: "20%",
        },
      ...
      {
        id: "6",
        url: require("@/assets/set2/icon6.png"),
        isFooter: true,
        style: {
          width: "60%",
        },
      ...
      {
        id: "8",
        url: require("@/assets/set2/icon8.png"),
        isFooter: true,
        style: {
          width: "35%",
        },
      ...
      {
        id: "12",
        url: require("@/assets/set2/icon9.png"),
        isFooter: false,
        style: {
          left: "78%",
          top: "59%",
  ...
  },
  {
    ...
    icons: [
      {
        id: "1",
        url: require("@/assets/set3/icon1.png"),
        isFooter: true,
        style: {
          width: "50%",
        },
      ...
      {
        id: "3",
        url: require("@/assets/set3/icon3.png"),
        isFooter: false,
        style: {
          position: "absolute",
          top: "59%",
      ...
      {
        id: "5",
        url: require("@/assets/set3/icon5.png"),
        isFooter: true,
        style: {
          width: "50%",
        },
      ...
      {
        id: "6",
        url: require("@/assets/set2/icon3-1.png"),
        isFooter: true,
        style: {
          width: "18%",
        },
      ...
      {
        id: "7",
        url: require("@/assets/set3/icon7.png"),
        isFooter: true,
        style: {
          width: "50%",
        },
      ...
      {
        id: "9",
        url: require("@/assets/set3/icon8.png"),
        isFooter: true,
        style: {
          width: "20%",
        },
      ...
      {
        id: "10",
        url: require("@/assets/set3/icon9.png"),
        isFooter: false,
        style: {
          position: "absolute",
          top: "45%",
      ...
      {
        id: "11",
        url: require("@/assets/set3/icon4.png"),
        isFooter: false,
        style: {
          position: "absolute",
          top: "57%",
      ...
      {
        id: "12",
        url: require("@/assets/set1/icon7.png"),
        isFooter: true,
        style: {
          width: "40%",
        },
